...
# print(dog, cat, '좋아요~', sep=' ') -> print 함수의 기본 값
print(dog, cat, '좋아요~', sep='') # , 로 생기는 공백을 없애주겠다는 뜻. 안에 들어간 것이 중간에 들어감.
...
print(dog, cat, '좋아요~', end='!!!\n')
print('이 문장을 줄 개행이 되어서 나올까요?')


print(dog, cat, '좋아요~',  sep='->', end='')
# print(end='->', sep='', dog, cat, '좋아요~') (x) -> 출력 내용을 앞에 쓰고 써줘야 한다.
print('야호~!')
