...
print(f'55번을 획득한 학생은 {points.index(55) + 1}번째 학생입니다.')
...
points.sort()
points.sort(reverse=True) # 처음부터 내림차로 프린트 하는법.
print(points)
